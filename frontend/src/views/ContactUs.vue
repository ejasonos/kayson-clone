...
<template>
  <section class="flex flex-col p-5 lg:p-10 xl:px-20 xl:flex-row xl:space-x-10 gap-y-5">
    <div class="flex flex-col space-y-3 xl:w-1/4">
      <div class="flex flex-col space-y-3">
        ...
        <div class="flex items-center space-x-2">
          <div class="p-1 h-8 w-8 bg-gray-300 hover:bg-blue-800"><img
            src="/facebook.svg"
            class="filter invert-95 w-full h-full"
          /></div>
          <div class="p-1 h-8 w-8 bg-gray-300 hover:bg-blue-600"><img
            src="/linkedin.svg"
            class="filter invert-95 w-full h-full"
          /></div>
          <div class="p-1 h-8 w-8 bg-gray-300 hover:bg-amber-600"><img
            src="/instagram.svg"
            class="filter invert-95 w-full h-full"
          /></div>
          <div class="p-1 h-8 w-8 bg-gray-300 hover:bg-red-600"><img
            src="/google.svg"
            class="filter invert-95 w-full h-full"
          /></div>
          <div class="p-1 h-8 w-8 bg-gray-300 hover:bg-blue-400"><img
            src="/message.svg"
            class="filter invert-95 w-full h-full"
          /></div>
        </div>
      ...
      <div class="flex flex-col space-y-3">
        ...
        <div class="flex flex-col text-sm text-gray-600 space-y-3">
          ...
          <div class="flex flex-col space-y-2">
            <div class="flex items-center space-x-2">
              <div class="p-2 h-8 w-8 rounded-full bg-gray-400 hover:bg-green-500">
                <img
                  src="/phone.svg"
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-green-600"><a href="mailto:info@kayson.com.ng">info@kayson.com.ng</a></span>
            </div>
            <div class="flex items-center space-x-2">
              <div class="p-2 h-8 w-8 rounded-full bg-gray-400 hover:bg-green-500">
                <img
              ...
              <span class="text-green-600"><a href="mailto:bookings@kayson.com.ng">bookings@kayson.com.ng</a></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex flex-col space-y-3 xl:w-3/4">
      ...
      >
        <label for="name" class="text-sm text-gray-400">Your Name (required)</label
        ><input
          type="text"
          v-model="name"
          name="name"
        ...
        />
        <label for="email" class="text-sm text-gray-400">Your Email (required)</label
        ><input
          type="email"
          v-model="email"
          name="email"
        ...
        ></textarea>
        <button type="submit" class="w-fit px-5 py-2 rounded-sm bg-green-500 uppercase font-bold text-white text-sm hover:bg-gray-600 border-2 border-green-500">Send</button>
      </form>
    </div>
  </section>
</template>
